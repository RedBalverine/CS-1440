...
void TriangleTester::testEquilateralTriangles()
{
    ...
    if (p->getX()!=0 || p->getY()!=17.32050808 || p->getZ()!=0)
    {
        std::cout << "Point 2 of triangle is not as expected, namely (6,4,3)" << std::endl;
        return;
    }
...
void TriangleTester::testIsoscelesTriangles()
{
    ...
    std::string input = "10,0,0 | 0,10,0 | 0,0,0";
    Triangle t(input);
    if (!t.isValid())
    {
        std::cout << "Failure to constructor a triangle from 3 points; unexpectedly invalid" << std::endl;
    ...
    if (!approximatelyEquals(t.computerArea(), 50, 0.001))
    {
        std::cout << "Triangle: unexpected area of "
                  << t.computerArea() << std::endl;
        return;
...
void TriangleTester::testScaleneTriangles()
{
    ...
    std::string input = "10,0,0 | 0,8,0 | 0,0,0";
    Triangle t(input);
    ...
    if (!approximatelyEquals(t.computerArea(), 40, 0.001))
    {
        std::cout << "Triangle: unexpected area of "
                  << t.computerArea() << std::endl;
        return;
...
void TriangleTester::testNonTriangles()
{
    ...
    if(t.isTriangle())
    {
        std::cout << "Unexpected Result. 'Hello' is not a triangle" << std::endl;
    }
...
void TriangleTester::testInvalid()
{
    ...
    if(t.isValid())
    {
        std::cout << "Unexpected Result. 'Hello' is not a valid triangle" << std::endl;
    }
